...
$query = "SELECT * from tramite WHERE unidad_responsable='AUTORIZACIONES AMBIENTALES'";
$result = pg_query($query);
$datas[$id] = array();
$id=0;
while($row = pg_fetch_array($result))
{
$datas[$id] = array($row['numero_rd'],$row['nombre_solicitante'],$row['tramite'],$row['fecha']);
$id++;
}
return $datas; 
}
...
$pdf->AddPage();
$pdf->Cell(50,'','AUTORIZACIONES AMBIENTALES',0,'C',false); 
$pdf->Ln(10);
$header=array('RD','SOLICITANTE','TRAMITE','FECHA');
