...
$query = "SELECT * from tramite WHERE tramite='Autorizacion para Realizar Contrucciones,Eventos en Zonas Costeras'";
...
$pdf->AddPage();
$pdf->Cell(50,'','Autorizacion para Realizar Contrucciones,Eventos en Zonas Costeras',0,'C','false'); 
$pdf->Ln(10);
