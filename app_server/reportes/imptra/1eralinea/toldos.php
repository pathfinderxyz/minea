...
$query = "SELECT * from tramite WHERE tramite='Autorizacion o Renovacion del Permiso Toldos'";
...
$pdf->AddPage();
$pdf->Cell(50,'','Autorizacion o Renovacion del Permiso para la Colocacion de Toldos',0,'C','false'); 
$pdf->Ln(10);
