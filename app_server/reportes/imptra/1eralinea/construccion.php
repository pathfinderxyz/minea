...
$query = "SELECT * from tramite WHERE tramite='Autorizacion para Construir ,Remodelar,demoler o utilizar maquinaria pesada'";
$result = pg_query($query);
$datas[$id] = array();
$id=0;
while($row = pg_fetch_array($result))
{
$datas[$id] = array($row['numero_rd'],$row['nombre_solicitante'],$row['cedula'],$row['fecha']);
$id++;
}
return $datas; 
}
...
$this->Cell(95,6,$col1[1],1);
$this->Cell(90,6,$col1[2],1); 
$this->Cell(50,6,$col1[3],1); 
$this->Ln();
}
}
}
...
$pdf->AddPage();
$pdf->Cell(50,'','Autorizacion para Construir ,Remodelar,demoler o utilizar maquinaria pesada',0,'C','false'); 
$pdf->Ln(10);
$header=array('RD','SOLICITANTE','CEDULA/RIF','FECHA');
