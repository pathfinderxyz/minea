...
$query = "SELECT * from tramite WHERE tramite='Fianza de Fiel Cumplimiento y pago de timbres fiscales'";
...
$pdf->AddPage();
$pdf->Cell(50,'','Fianza de Fiel Cumplimiento y pago de timbres fiscales',0,'C','false'); 
$pdf->Ln(10);
